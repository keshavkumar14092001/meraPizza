...
function initAdmin() {
  var adminTable = document.querySelector('#adminOrderTableBody');
  var orders = [];
  var markUp;
  axios.get('/admin/orders', {
    ...
    orders = res.data, markUp = generateMarkup(orders), adminTable.innerHTML = markUp;
  })["catch"](function (err) {
    console.log(err);
  });

  function renderItems(items) {
    var itemsValues = Object.values(items);
    return itemsValues.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.item.name, "-").concat(menuItem.qty, "</p>\n            ");
    }).join('');
  }
...
var addToCart = document.querySelectorAll('.pizzaButton');
var cartCounter = document.querySelector('#totalPizza');
...
var order = Order ? Order.value : null;
var i = 0;
var j;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrelatime_pizza_tracking_app"] = self["webpackChunkrelatime_pizza_tracking_app"] || [];
